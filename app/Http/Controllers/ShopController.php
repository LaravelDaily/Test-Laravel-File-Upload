...
class ShopController extends Controller
{
    public function store(Request $request)
    {
        ...
        // $img = Image::make(storage_path('app/shops/'.$filename))->resize(500, 500)->save(storage_path('app/shops/resized-'.$filename));
        $img = Image::make(storage_path('app/'.$path))->resize(500, 500)->save(storage_path('app/shops/resized-'.$filename));
